...
//using NorthwindService.Repositories.ICustomerRepository;
...
namespace NorthwindService.Repositories
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public async Task<Customer> UpdateAsync(string id, Customer c)
        {
            ...
            c.CustomerID = c.CustomerID.ToUpper();
            // update in database
            var existing = db.Customers.FirstOrDefault(x => x.CustomerID == id);
            ...
            {
                existing.ContactName = c.CompanyName;
            }
            if (c.ContactTitle != null)
            {
                existing.ContactTitle = c.CompanyName;
            }
            if (c.Address != null)
            {
            ...
            {
                // update in cache
                return UpdateCache(id, existing);
            }
            return null;
        }
        /*
        public async Task<Customer> PatchAsync(string id, Customer c)
